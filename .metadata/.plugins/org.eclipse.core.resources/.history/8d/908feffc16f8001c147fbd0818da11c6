...
public class ExtentManager {
    ...
    public static ExtentReports createInstance() {
        String fileName = getReportPath("/home/arbrownappliedi/eclipse-workspace3/MedicareProject/TestReport");
		...
		extent.setSystemInfo("CapProj", "Simplearn");
		extent.setSystemInfo("AUT", "AmberB");
